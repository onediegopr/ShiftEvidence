...
import { ArrowLeft, BadgePercent, CircleAlert, CreditCard, FileText, ShieldCheck } from "lucide-react";
...
export const metadata: Metadata = {
  title: "Checkout Coming Soon | Shift Evidence",
  description: "Safe placeholder for future Lemon Squeezy checkout routes.",
};
        ...
        <section className="section" style={{ paddingTop: "8rem" }}>
          <div className="container">
            <section className="dashboard-hero glass-card">
              <div>
                <div className="badge badge-cyan">Billing placeholder</div>
                <h1>{state.headline}</h1>
                <p>{state.detail}</p>
                <p className="assessment-inline-note">
                  Plan: {plan.displayName}. Provider: Lemon Squeezy. No checkout session, payment, order, webhook or entitlement is created here.
                </p>
              </div>
            ...
            <section className="assessment-summary-grid" style={{ marginTop: "2rem" }}>
              ...
              <article className="glass-card assessment-summary-card">
                ...
                <strong>{plan.checkoutEligible ? "Prepared" : "Not eligible"}</strong>
                <p>Lemon Squeezy wiring is design-only.</p>
              </article>
              <article className="glass-card assessment-summary-card">
                <CircleAlert size={22} />
                <span className="assessment-summary-label">Runtime state</span>
                <strong>{statusLabel(state.status)}</strong>
                <p>No API keys or variant IDs are required for build.</p>
              </article>
            </section>
            ...
            <section className="assessment-section glass-card" style={{ marginTop: "2rem" }}>
              <div className="assessment-section-title">
                ...
                <h2>No payment is active yet</h2>
                <p>
                  This route exists so future checkout can be enabled centrally after credentials and variant IDs are added.
                  Until then, use invoice or support follow-up.
                </p>
              </div>
