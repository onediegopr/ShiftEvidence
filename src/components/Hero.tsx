    ...
    <section className="section" style={{ paddingTop: '9rem', paddingBottom: '6rem' }}>
      ...
      <div className="container hero-grid">
        ...
        <div className="hero-visual">
          <svg className="migration-flow-svg" viewBox="0 0 500 400" xmlns="http://www.w3.org/2000/svg">
            <defs>
              {/* Gradients */}
            ...
            <path d="M 90,200 Q 250,110 410,200" fill="none" stroke="url(#tunnelGrad)" strokeWidth="8" strokeLinecap="round" />
            <path d="M 90,200 Q 250,110 410,200" fill="none" stroke="rgba(255, 255, 255, 0.05)" strokeWidth="2" strokeDasharray="5 5" />

            {/* VMware Source Node Group */}
            <g transform="translate(40, 160)">
              <rect x="0" y="0" width="100" height="80" rx="12" fill="rgba(17, 24, 39, 0.85)" stroke="rgba(239, 68, 68, 0.4)" strokeWidth="1.5" />
              <rect x="0" y="0" width="100" height="80" rx="12" fill="none" stroke="#ef4444" strokeWidth="1" opacity="0.3" filter="url(#glow)" />
              <text x="50" y="32" fill="#ef4444" fontSize="11" fontWeight="700" textAnchor="middle" letterSpacing="0.05em">VMWARE</text>
              <text x="50" y="52" fill="rgba(255,255,255,0.8)" fontSize="14" fontWeight="800" textAnchor="middle">vSphere</text>
              <circle cx="50" cy="-5" r="3" fill="#ef4444" />
              <circle cx="50" cy="-5" r="6" fill="none" stroke="#ef4444" strokeWidth="1" opacity="0.5">
                <animate attributeName="r" values="3;10;3" dur="2s" repeatCount="indefinite" />
              </circle>
            </g>

            {/* Proxmox Target Node Group */}
            <g transform="translate(360, 160)">
              <rect x="0" y="0" width="100" height="80" rx="12" fill="rgba(17, 24, 39, 0.85)" stroke="rgba(6, 182, 212, 0.4)" strokeWidth="1.5" />
              <rect x="0" y="0" width="100" height="80" rx="12" fill="none" stroke="#06b6d4" strokeWidth="1" opacity="0.3" filter="url(#glow)" />
              <text x="50" y="32" fill="#06b6d4" fontSize="11" fontWeight="700" textAnchor="middle" letterSpacing="0.05em">PROXMOX VE</text>
              <text x="50" y="52" fill="rgba(255,255,255,0.8)" fontSize="14" fontWeight="800" textAnchor="middle">KVM / LXC</text>
              <circle cx="50" cy="-5" r="3" fill="#06b6d4" />
              <circle cx="50" cy="-5" r="6" fill="none" stroke="#06b6d4" strokeWidth="1" opacity="0.5">
                <animate attributeName="r" values="3;10;3" dur="2s" repeatCount="indefinite" />
              </circle>
            </g>
            ...
            {/* Animated Nodes Traveling (VMs migrating) */}
            {/* VM 1 */}
            <g>
              <circle r="6" fill="#8b5cf6" filter="url(#glow)">
                <animateMotion 
                  path="M 90,200 Q 250,110 410,200" 
                  dur="4.5s" 
              ...
              <text fill="#a5b4fc" fontSize="9" fontWeight="700" textAnchor="middle" y="-12">
                <animateMotion 
                  path="M 90,200 Q 250,110 410,200" 
                  dur="4.5s" 
                  repeatCount="indefinite"
            ...
            <g>
              ...
              <text fill="#e0f2fe" fontSize="9" fontWeight="700" textAnchor="middle" y="-12">
                <animateMotion 
                  path="M 90,200 Q 250,110 410,200" 
                  dur="4.5s" 
                  begin="1.5s"
            ...
            <g>
              ...
              <text fill="#f3e8ff" fontSize="9" fontWeight="700" textAnchor="middle" y="-12">
                <animateMotion 
                  path="M 90,200 Q 250,110 410,200" 
                  dur="4.5s" 
                  begin="3s"
