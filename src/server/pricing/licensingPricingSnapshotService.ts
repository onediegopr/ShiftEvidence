...
export async function runManualPricingRefresh(params: AdminActor) {
  ...
  const snapshots = await Promise.all([
    createDraftPricingSnapshot({
      ...
      currency: "USD",
      sourceName: "VMware/Broadcom pricing placeholder",
      sourceType: "placeholder",
      lastCheckedAt: checkedAt,
      notesInternal: "Placeholder only. Validate official or manual admin source before approval.",
      metadataJson: { refreshRunId: run.id, approvedAutomatically: false },
      items: [
        {
          vendor: "vmware",
          productName: "VMware/Broadcom licensing placeholder",
          metric: "manual",
          unitPriceUsd: null,
          sourceNote: "No official price captured in COST-1A.",
        },
      ],
    }),
    createDraftPricingSnapshot({
      ...
      status: "pending_review",
      currency: "USD",
      sourceName: "Proxmox pricing placeholder",
      sourceType: "placeholder",
      lastCheckedAt: checkedAt,
      notesInternal: "Placeholder only. Validate official or manual admin source before approval.",
      metadataJson: { refreshRunId: run.id, approvedAutomatically: false },
      items: [
        {
          vendor: "proxmox",
          productName: "Proxmox subscription placeholder",
          metric: "subscription",
          unitPriceUsd: null,
          sourceNote: "No official price captured in COST-1A.",
        },
  ...
  const completedRun = await completePricingRefreshRun({
    ...
    summary: "Se crearon snapshots placeholder pendientes de revision. No se aprobaron cambios automaticamente.",
    detailsJson: {
      mode: "manual_controlled",
      connectors: "not_configured",
      approvedAutomatically: false,
  ...
  await recordAdminAuditEvent({
    ...
    entityType: "LicensingPricingRefreshRun",
    entityId: completedRun.id,
    message: "Refresh manual de Pricing Intelligence creo snapshots placeholder pendientes.",
    metadataJson: {
      status: completedRun.status,
      createdDraftSnapshotsCount: completedRun.createdDraftSnapshotsCount,
      errorsCount: completedRun.errorsCount,
