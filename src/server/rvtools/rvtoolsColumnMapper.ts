...
export function parseDatastoreRow(
  ...
  const usedGb = convertToGb(getFieldValue(row, DATASTORE_FIELD_ALIASES.usedGb), usedHeader);
  ...
  const usagePercent = parseNumberLike(getFieldValue(row, DATASTORE_FIELD_ALIASES.usagePercent));
